...
4、toDo，多线程未实现，参考https://blog.csdn.net/joson1234567890/article/details/90730193
"""
...
class Database(object):
    """
    MYSQL数据库对象，负责产生数据库连接 , 此类中的连接采用连接池实现获取连接对象：conn = Database.getConn()
            释放连接对象;conn.close()或del conn
    """

    def __init__(self):
        # 数据库构造函数，从连接池中取出连接，并生成操作游标
        self._conn = Database.__getConn()
