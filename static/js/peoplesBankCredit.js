 ...
 */
function login(){
    var url='/my-test/peoplesBankCredit/create',
        data={
            loginId:$("#loginId").val(),
            logPwd:$("#loginPwd").val(),
            verifyCode:$("#reportNo").val(),
...
function getImgCode() {
    var url='/my-test/peoplesBankCredit/status',
        data={
            tradeNo:$("#tradeNo").val(),
            testType:$("#project_select").val(),
        };
...
function inputMsg() {
    var url='/my-test/peoplesBankCredit/input',
        data={
            tradeNo:$("#tradeNo").val(),
...
function notify(){
    window.open("notify.html?taskId="+$("#taskId").val() +"&project="+$("#project_select").val()+"&taskType=ZHENGXIN" +
        "&msg=" + $("#msg").val());
}

function query(){
    window.open("../../work/peoplesBankCredit.html?tradeNo="+$("#tradeNo").val()+"&testType="+$("#project_select").val()
