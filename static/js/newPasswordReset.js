...
function login(){
    ...
    var url='/my-test/PasswordReset/create',
        data={
...
function getImgCode() {
    var url='/my-test/PasswordReset/status',
        data={
            tradeNo:$("#tradeNo").val(),
            testType:$("#project_select").val(),
        };
...
function refreshMessage() {
    var url='/my-test/xinqixiang/refreshMessage',
        data={
            tradeNo:$("#tradeNo").val(),
...
function inputMsg() {
    var url='/my-test/PasswordReset/postCode',
        data={
            tradeNo:$("#tradeNo").val(),
            verifyCode:$("#i_img_code").val(),
            testType:$("#project_select").val(),
...
function inputNewPassword() {
    ...
    var url='/my-test/PasswordReset/postPassword',
        data={
            tradeNo:$("#tradeNo").val(),
