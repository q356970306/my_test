...
function notify(){
    window.open("notify.html?taskId="+$("#taskId").val() +"&project="+$("#project_select").val()+"&taskType=MAIMAI" +
                "&msg=" + $("#msg").val());
}

function query(){
    window.open("../../work/maimai.html?tradeNo="+$("#tradeNo").val()+"&testType="+$("#project_select").val());
}